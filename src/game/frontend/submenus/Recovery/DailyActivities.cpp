...
namespace YimMenu::Submenus
{
	std::shared_ptr<Category> BuildDailyActivitiesMenu()
	{
		...
		auto hiddenCacheTab      = std::make_shared<CollapsingHeaderItem>("隐藏藏宝");
		auto treasureChestTab    = std::make_shared<CollapsingHeaderItem>("宝箱");
		auto shipwreckedTab      = std::make_shared<CollapsingHeaderItem>("沉船");
		auto buriedStashTab      = std::make_shared<CollapsingHeaderItem>("埋藏物");
		auto skydiveTab          = std::make_shared<CollapsingHeaderItem>("垃圾能量跳伞");
		auto timeTrialsTab       = std::make_shared<CollapsingHeaderItem>("计时赛");
		auto exoticExportsTab    = std::make_shared<CollapsingHeaderItem>("异国出口");
		auto deadDropTab         = std::make_shared<CollapsingHeaderItem>("G的藏匿点");
		...
		auto lsTagsTab           = std::make_shared<CollapsingHeaderItem>("LS涂鸦");
		auto madrazoHitsTab      = std::make_shared<CollapsingHeaderItem>("玛德拉索暗杀");
		auto wildlifePhotography = std::make_shared<CollapsingHeaderItem>("动物摄影");
		auto smokeOnTheWater     = std::make_shared<CollapsingHeaderItem>("水上烟雾");
		auto goldenClover        = std::make_shared<CollapsingHeaderItem>("金三叶草");
