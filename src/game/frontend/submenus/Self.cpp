...
namespace YimMenu::Submenus
{
	Self::Self() :
	    ...
	    Submenu::Submenu("自我", ICON_FA_USER)
	{
		...
		setWanted->AddItem(std::make_shared<IntCommandItem>("wantedslider"_J, "等级"));
		...
		specialInMp->AddItem(std::make_shared<BoolCommandItem>("mpspecialability"_J, "线上模式启用"));
